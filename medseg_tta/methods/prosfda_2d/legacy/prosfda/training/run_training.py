...
def main():
    ...
    parser.add_argument('--model', default='unet', required=False, help='Model name.')
    parser.add_argument('--gpu', type=int, nargs='+', default=[0], required=False, help='Device id.')
    parser.add_argument('--log_folder', required=True, help='Log folder.')
    parser.add_argument('--tag', default='{}'.format(gen_random_str()), required=False, help='Run identifier.')
    ...
    parser.add_argument('--initial_lr', type=float, default=0.01, required=False, help='initial learning rate.')
    ...
    parser.add_argument('--num_threads', type=int, default=4, required=False, help='Threads number of dataloader.')
    parser.add_argument('-r', '--root', required=True, help='dataset root folder.')
    parser.add_argument('--tr_csv', nargs='+', required=True, help='training csv file.')
    parser.add_argument('--ts_csv', nargs='+', required=True, help='test csv file.')
    parser.add_argument('--num_epochs', type=int, default=100, required=False, help='num_epochs.')
    parser.add_argument('--pretrained_model', required=False, help='pretrained model path.')
    parser.add_argument('--alpha', type=float, default=0.01, required=False, help='alpha in BN loss.')
    parser.add_argument('--layers', type=int, default=5, required=False, help='layers to calculate bn loss.')
    parser.add_argument('--prompt_model_path', required=False, help='domain-aware prompt model path.')
