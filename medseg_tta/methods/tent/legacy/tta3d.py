...
def test_on_target(args, device):
    ...
    try:
        ...
        adapted_model_path = os.path.join(weights_dir, f'{model_name}_{args.img}_tta_adapted_{timestamp}.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_root', type=str, default='/home/yuwenjing/data/BraTS-PED/Test', help='目标数据集根目录路径')
