...
def get_args():
   ...
   # Directories and file paths
    parser.add_argument('--data_dir', type=str, default=str(artifact_dir / "target"), help='Path to the data domain directory')
    parser.add_argument('--sample_dir', type=str, default=str(artifact_dir / "selected"), help='Path to the translated data directory')
    parser.add_argument('--save_dir', type=str, default=str(artifact_dir / "finetune" / "seed_3"), help='Path to save checkpoints')
    parser.add_argument('--checkpoint', type=str, default=str(artifact_dir / "checkpoints" / "source_seg" / "seed_3" / "ckpt" / "best_val.pth.tar"), help='Path to saved checkpoints')
