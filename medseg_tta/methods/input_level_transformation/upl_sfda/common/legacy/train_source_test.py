...
def train(config, train_loader, valid_loader, list_data):
    ...
    if resume1:
        upl_model.load_state_dict(torch.load(r"D:\HDU\STORE\BRATS_dataloader\UPL-SFDA-BRATS\checkpoint\unet3d_DGTTA_SSA.pth",map_location=device))
        print('load model')
...
def main():
    ...
    parser.add_argument('--config', type=str, default=r"D:/HDU\STORE\SFADA-GTV-Seg/Code_OA/tent/all/train3d.cfg",
