...
def initialize_network(threeD=True, num_classes=2,in_chns=1):
    """
    ...
    default_dict['num_input_channels'] = in_chns
    default_dict["num_classes"] = num_classes
    print('num_input_channels',default_dict['num_input_channels'])
