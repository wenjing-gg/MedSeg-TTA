...
def Savefeat(cfg, logger):
    ...
    full_dataset_objective_vectors = np.zeros([len(train_loader), 1, 512])
    ...
    os.makedirs('./features_t1c', exist_ok=True)
    torch.save(full_dataset_objective_vectors, './features_t1c/WCH_dataset_objective_vectors_512.pkl')
...
class Class_Features:
    ...
    def calculate_mean_vector(self, feat_cls, outputs, labels_val, model):
        ...
        #print("outputs_softmax.shape, feat_cls.shape = ",outputs_softmax.shape, feat_cls.shape)
        tensor1, tensor2,tensor3,tensor4 = torch.split(outputs_softmax, 1, dim=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="source_to_target")
