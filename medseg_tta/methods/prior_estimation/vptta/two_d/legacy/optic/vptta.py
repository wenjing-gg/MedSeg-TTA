...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "vptta" / "optic"
DEFAULT_DATA_ROOT = REPO_ROOT / "data" / "VPTTA" / "Fundus"
DEFAULT_MODEL_ROOT = REPO_ROOT / "checkpoints" / "vptta" / "optic"
...
class VPTTA:
    ...
    def build_model(self):
        ...
        checkpoint_path = self.checkpoint or os.path.join(self.load_model, 'last-Res_Unet.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default=None,
                        help='direct path to the shared initialized OPTIC checkpoint')
