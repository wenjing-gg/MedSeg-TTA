...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "vptta" / "polyp"
DEFAULT_DATA_ROOT = REPO_ROOT / "data" / "VPTTA" / "Polyp"
DEFAULT_MODEL_ROOT = REPO_ROOT / "checkpoints" / "vptta" / "polyp"
...
class VPTTA:
    ...
    def build_model(self):
        ...
        checkpoint_path = self.checkpoint or os.path.join(self.load_model, 'pretrain-PraNet.pth')
...
if __name__ == '__main__':
    ...
    # Path
    parser.add_argument('--path_save_log', type=str, default=str(DEFAULT_OUTPUT_ROOT / "logs"))
    parser.add_argument('--model_root', type=str, default=str(DEFAULT_MODEL_ROOT))
    parser.add_argument('--checkpoint', type=str, default=None,
                        help='direct path to the shared initialized POLYP checkpoint')
