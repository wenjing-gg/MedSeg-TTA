...
def main():
    ...
    parser.add_argument('--chk', default='model_final.model', required=False, help='Checkpoint name.')
    ...
    parser.add_argument('--inference_tag', default='all', required=False, help='Inference tag.')
    parser.add_argument('--patch_size', type=int, nargs='+', default=[512, 512], required=False, help='patch size.')
    parser.add_argument('-r', '--root', required=True, help='root folder.')
