...
def dice(output, target, eps=1e-05):
    eps = 1e-05
...
def Dice(pred, gt, smooth=1e-05, activation='sigmoid'):
...
def ppv(output, target, smooth=1e-05):
...
def main():
    ...
    hd95_ec, hd95_co, hd95_wt = cal_hd95_np(output, label)
