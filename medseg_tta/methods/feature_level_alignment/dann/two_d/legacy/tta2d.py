...
def train_on_target(args, device, epoch):
    ...
    # ---------------- Paths --------------------------------------------------
    result_dir = os.path.join("DANN_2D", "tta2d_results")
    weights_dir = os.path.join(result_dir, "weights")
    os.makedirs(weights_dir, exist_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_dir", type=str, default="/home/yuwenjing/data/tta_dataset/TTA-2DUS/DDTI",
                        help="包含 image/ 和 mask/ 的目标域文件夹")
    parser.add_argument("--checkpoint_dir", type=str, default="./checkpoints-DANN", help="保存 / 查找权重的目录")
    parser.add_argument("--model_path", type=str, default="/home/yuwenjing/DeepLearning_ywj/tta/tent/checkpoint_US/unet2d_best_US.pth",
