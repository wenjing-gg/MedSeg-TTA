...
Validation was run locally with Python 3.12.2 after generating the unified package.
...
The generated `medseg_tta` Python files were also checked for leading `#` comments and AST-detectable docstrings; both counts were zero.
