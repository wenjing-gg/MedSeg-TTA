...
def _print_help() -> int:
    ...
    print()
    print("AIF-SFDA legacy training wrapper")
    print("Forward target: medseg_tta.methods.input_level_transformation.aif_sfda.two_d.legacy/procedures/train.py")
    print()
    print("Default injected args: --model_name AIF_SFDA")
    print("Pass --data_dirname, --output_nc, and pretrained checkpoint paths as needed.")
    return 0
