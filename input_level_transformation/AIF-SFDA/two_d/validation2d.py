...
def _print_help() -> int:
    ...
    print()
    print("AIF-SFDA legacy validation wrapper")
    print("Forward target: medseg_tta.methods.input_level_transformation.aif_sfda.two_d.legacy/procedures/validation.py")
    print()
